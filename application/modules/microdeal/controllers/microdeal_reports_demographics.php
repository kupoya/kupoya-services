<?php
/**
 * Microdeal Reports Demographics
 * 
 ...
 */
class Microdeal_Reports_Demographics extends Authenticated_Controller {
    ...
    public function index($strategy_id = 0, $campaign_id = 0)
    {
        ...
        $this->template->build('reports/strategy_reports_demographics', $data);
