<?php
	...
	$strategy_graph_platform_url = base_url();
	$div_id = uniqid();

	if (isset($strategy['id']))
	{
		$strategy_graph_platform_url .= 'strategy/reports/mobile/platform_get_all/'.$strategy['id'];
	}
...
?>
			...
			<!-- Begin Pie Chart By Day -->
				    ...
				    function drawChartPie_Day() {
				      ...
				      var jsonData = $.ajax({
				          url: "<?php echo $strategy_graph_platform_url; ?>",
				          type: 'POST',
				          dataType:"json",
				          async: false
			          }).responseText;
